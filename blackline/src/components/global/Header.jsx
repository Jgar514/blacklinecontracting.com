...
function Header({ title }) {
	return (
		<div className="border-b-4 border-black bg-cover bg-center flex items-center justify-center h-46 md:h-128 w-full mt-0" style={{ backgroundImage: `url(${hero})` }}>
			<div className="bg-white/40 w-full h-full md:w-10/12 lg:w-10/12 px-4 py-16 text-center flex flex-col  justify-center items-center gap-y-2 mt-8">
				<nav className="flex" aria-label="Breadcrumb">
					<ol className="inline-flex items-center space-x-1 md:space-x-3">
						<li className="inline-flex items-center">
							<a href="#" className="inline-flex items-center  font-medium text-gray-700 hover:text-blue-600 text-xl  dark:text-gray-400 dark:hover:text-white">
