				...
				<div className="container mx-auto">
					<div className="flex h-full items-center justify-center dark:bg-[#23272F]/70">
						<div className="bg-white/70 dark:bg-[#23272F]/70 w-full md:w-10/12 lg:w-10/12 px-4 py-4 text-center flex flex-col gap-y-2 lg:gap-y-8 mt-2 border-black md:border-2">
							...
							<p className="rounded-2xl text-black py-2 px-2 text-lg md:text-lg lg:text-2xl bg-white/80 dark:bg-transparent mt-4n dark:text-white ">{business.tagline}</p>
							<div className="flex flex-row justify-center gap-6">
								<Button to="/contact">{business.CTA}</Button>
								<a className="inline-flex text-black dark:text-white justify-center items-center font-bold hover:underline  py-2 mr-2 px-2 " href="/about">
